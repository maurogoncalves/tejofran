                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1>Cadastrar CND Mobili&aacuteria <small>	
									<?php 				  
									...
									?></small></h1>
                                <ol class="breadcrumb">
                                    <li class="active">Cadastrar CND Mobili&aacuteria </li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- end .page title-->
                    ...
                    <div class="row">                       
                        <div class="col-md-12">
                            <div class="panel panel-card margin-b-30">
								...
								echo form_open_multipart('cnd_mob/cadastrar_cnd_mob', $attributes); 
								?>		
                                <div class="panel-body">
                                 <form class="form-horizontal">									
									<div class="form-group">
										...
										<div class="col-lg-4">
											<input type="text" readonly='yes' name='cpf_cnpj' id='cpf_cnpj' class="form-control"  required="" value='<?php echo $emitente[0]->cpf_cnpj;?>'>                              
										</div>
										
										<label class="col-lg-2 control-label">Inscri&ccedil;&atilde;o Mobili&aacute;ria</label>
										<div class="col-lg-4">
											<input type="text" readonly='yes'  id='inscricao' name='inscricao' class="form-control" value='<?php echo $emitente[0]->inc_cnd_mob;?>'>								
											 <input type="hidden"  id='id_loja' name='id_loja' class="form-control" value='<?php echo $emitente[0]->id_loja;?>'>								 
										</div>

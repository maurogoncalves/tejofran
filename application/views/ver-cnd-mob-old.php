              ...
              <div class="row mt">
				  ...
				  <span class='pull-right' style='font-weight:bold'>
                      ...
                      <div class="form-panel">
							 ...
							 ?>							  <?php if($imovel[0]->possui_cnd == 1){  ?>							 <div class="form-group">                              <label class="col-sm-2 col-sm-2 control-label">N&uacute;mero Inscri&ccedil;&atilde;o</label>                              <div class="col-sm-4">								<input type="text"  id='nome' readonly='yes' name='nome' class="form-control" value=' <?php echo $imovel[0]->ins_cnd_mob?>'   >                                                                                                </div>							                                <div class="col-sm-4">								                              </div>							</div>														<div class="form-group">														 <div class="col-sm-12">								<a href="<?php echo $this->config->base_url(); ?>assets/cnds_mob/<?php echo $imovel[0]->arquivo_cnd?>" download> Baixar Inscri&ccedil;&atilde;o</a>														<?php }else{  ?>														 <div class="form-group">                              <label class="col-sm-2 col-sm-2 control-label">Raz&atilde;o Social</label>                              <div class="col-sm-4">								<input type="text"  id='nome' readonly='yes' name='nome' class="form-control" value=' <?php echo $imovel[0]->ins_cnd_mob?>'   >                                                                                                </div>							                                <div class="col-sm-4">								                              </div>							</div>														<div class="form-group">														 <div class="col-sm-12">								<a href="<?php echo $this->config->base_url(); ?>assets/cnd_pend/<?php echo $imovel[0]->arquivo_pendencias?>" download> Baixar Arquivo Pend&ecirc;ncia</a>							<?php }  ?>							<!-- <img src="<?php //echo $this->config->base_url(); ?>assets/capas/<?php //echo $imovel[0]->id?>.jpg" width='400' height='400'> -- !>													</div>							</div>

<?php
								...
								<div class="form-group" >
									<label class="col-lg-12 control-label" style='font-size:16px;color:#002060;font-weight:bold;text-align:left!important'>Dados Dívidas Vencidas</label>
                                </div>
                                <div class="form-group" >
									<label class="col-lg-2 control-label">Encontre o CNPJ Raiz</label>
                                    <div class="col-lg-4">
									<input type="hidden"  id='tipo_ocorrencia' required  name='tipo_ocorrencia' value='7'   >
								...
								<div class="form-group">													
                                    ...
                                    <div class="col-lg-4">
                                      	<input type="text" data-masked="" required data-inputmask="'mask': '99/99/9999' " id='dataDivida' name='dataPefin' tabindex="5" class="form-control" value='<?php echo $valor['data_protesto_br'] ?>'   >
                                    </div>	

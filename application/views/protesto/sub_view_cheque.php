<?php
								...
								<?php 								 
									if($op == 1){
										...
										$valor['cnpj_raiz'] = $dados[0]->cnpj_raiz;
								...
								<div class="form-group" >
									<label class="col-lg-12 control-label" style='font-size:16px;color:#002060;font-weight:bold;text-align:left!important'>Dados Cheques sem fundo</label>
                                </div>
                                <div class="form-group" >
									<label class="col-lg-2 control-label">Encontre o CNPJ Raiz</label>
                                    <div class="col-lg-4">
									<input type="hidden"  id='op' required  name='op' value='<?php echo $op ?>'   >
									<input type="hidden"  id='cnpj_bd' required  name='cnpj_bd'  value='<?php echo $valor['id_cnpj_raiz_segundo'] ?>'  >
									<input type="hidden"  id='idOco' required  name='idOco' value='<?php echo $valor['idOco'] ?>'  >
									
									<input type="hidden"  id='tipo_ocorrencia'   name='tipo_ocorrencia' value='3'   >

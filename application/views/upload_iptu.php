		 ...
		 <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1>Upload IPTU<small></small></h1>
                                <ol class="breadcrumb">
                                    <li><a href="<?php echo $this->config->base_url();?>index.php/iptu/listar"><i class="fa fa-home"></i>Listar IPTU</a></li>
                                    <li class="active">Upload IPTU</li>
                                </ol>
                            </div>
                        </div>
					...
					?>
						...
						<div class="col-md-12">
							...
							<div class="panel panel-card margin-b-30">
								...
								<div class="form-group">
									...
									<label class="col-lg-2 control-label" >Nome do Imóvel</label>

										<div class="col-lg-8">

											<input type="text"  id='' name='' class="form-control" value='<?php echo $imovel[0]->nome;	?>'  readonly='yes'  >	
									...
									<label class="col-lg-2 control-label" >N&uacute;mero Inscri&ccedil;&atilde;o</label>
										...
										<div class="col-lg-8">
											...
											<input type="text"  id='' name='' class="form-control" value='<?php echo $imovel[0]->inscricao;	?>'  readonly='yes'  >	
                        ...
                        <span class="btn btn-success fileinput-button">
							...
							<input id="fileupload"  type="file" name="userfile" data-url="<?php echo $this->config->base_url();?>index.php/iptu/enviar?id=<?php echo $imovel[0]->id?>">
						</span>
						<?php }else{ ?>
								<span class="btn btn-success fileinput-button">

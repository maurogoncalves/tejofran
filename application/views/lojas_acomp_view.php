...
<script>
	...
	$( "#area" ).change(function() {			
		var area = $("#area").val();		
			if(area !== '0'){			
				$.ajax({				
					url: "<?php echo $this->config->base_url(); ?>index.php/acomp_cnd/buscarSubArea?area=" + area,
				...
				$.ajax({				
					url: "<?php echo $this->config->base_url(); ?>index.php/acomp_cnd/buscarEtapa?area=" + area,
					type : 'get', /* Tipo da requisi&ccedil;&atilde;o */ 				
					contentType: "application/json; charset=utf-8",				
					dataType: 'json', /* Tipo de transmiss&atilde;o */				
					success: function(data){					
		...
		$( "#data_envio" ).blur(function() {									
			var data_envio = $('#data_envio').val();							
			$.ajax({								
				url: "<?php echo $this->config->base_url(); ?>index.php/acomp_cnd/calcularSLA?data_envio=" + data_envio ,
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1>Acompanhamento de CND<small></small></h1>
                            </div>
                        </div>
                    </div><!-- end .page title-->
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-card margin-b-30">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title"> Informa&ccedil;&otilde;es do Acompanhamento</h4>
                                ...
                                <div class="form-group">
									...
									<label class="col-lg-2 control-label">Data de Entrada</label>
									<div class="col-lg-4">
								...
								<div class="form-group">																						 
							 <label class="col-lg-2 col-lg-2 control-label">&Aacuterea </label>                              
							 <div class="col-lg-4">                                  
							...
							<label class="col-lg-2 col-lg-2 control-label">Sub &Aacute;rea  </label>                             
							<div class="col-lg-4">                                  
							...
							<div class="form-group">							  					
							<label class="col-lg-2 col-lg-2 control-label">Etapa  </label>                              
							<div class="col-lg-4">                                  
							<select name="etapa" id="etapa" required=""  class='custom-select' style='width:230px'>
							<option value="0">Escolha</option>									
							</select>                              
							</div>							  							  
							<label class="col-lg-2 col-lg-2 control-label">Tipo do D&eacute;bito</label> 
							<div class="col-lg-4">								  								 
							...
							<div class="form-group">							   
							<label class="col-lg-2 col-lg-2 control-label">Data Envio</label>                             
							<div class="col-lg-4">                                  
							<input type="text" name='data_envio' id='data_envio' class="form-control"  required="" data-masked="" data-inputmask="'mask': '99/99/9999' " >                              
							</div>							                                
							<label class="col-lg-2 col-lg-2 control-label">SLA</label>                              
							<div class="col-lg-4">                                  
							<input type="text" readonly='yes' name='sla' id='sla' class="form-control"  required=""  >                              
							</div>							  							
							</div>	
							<div class="form-group">														 
							<label class="col-lg-2 col-lg-2 control-label">&Acirc;mbito </label>                              
							<div class="col-lg-4">                              
							...
							<label class="col-lg-2 col-lg-2 control-label">Obs.:</label>
							<div class="col-lg-4">                                  
							<input type="text" name='observacoes' id='observacoes' class="form-control" > 
							</div>															
							</div>															
							<div class="form-group">							 
							<label class="col-lg-2 col-lg-2 control-label">Projeto</label>                              
							<div class="col-lg-4">                              
							...
							<label class="col-lg-2 col-lg-2 control-label"></label>                              
							<div class="col-lg-2">							   
							<input type="hidden" id='id' name='id'  value='<?php echo $dados_acomp[0]->id_loja; ?>'>
							<div class="form-group">
                                    <div class="col-lg-4 col-sm-offset-2">
										<?php if($visitante == 0){ ?>
											<button class="btn btn-primary" type="submit">Inserir Acomp.</button>
										<?php } ?>
                                    </div>
                                </div>
							</form>	

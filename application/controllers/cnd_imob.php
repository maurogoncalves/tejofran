...
function export_mun(){	
 ...
 function csvGrafico($result){
  ...
  function export_total_imob(){	
	...
	$result = $this->cnd_imobiliaria_model->listarIptuTotalCsv($idContratante,$possuiCnd);
...
function dados_agrupados(){	
	...
	$regionais = $this->cnd_imobiliaria_model->regionais();
	...
	foreach($regionais as $reg){
		...
		$result = $this->cnd_imobiliaria_model->contaCndRegional($idContratante,1,$reg->id);
	...
	foreach($regionais as $reg){
		...
		$result = $this->cnd_imobiliaria_model->contaCndRegional($idContratante,2,$reg->id);
	...
	foreach($regionais as $reg){
		...
		$result = $this->cnd_imobiliaria_model->contaCndRegional($idContratante,3,$reg->id);
